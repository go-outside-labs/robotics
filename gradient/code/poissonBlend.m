...
function [im_blend] = poissonBlend(im_object, im_background, im_mask)
...
for c=1:size(im_background, 2)
    for r=1:size(im_background, 1)
        ...
        im_blend(r, c, 1) = im_background(r, c, 1) + xr(i);
        im_blend(r, c, 2) = im_background(r, c, 2) + xg(i);
        im_blend(r, c, 3) = im_background(r, c, 3) + xb(i);
    end
end